...
$queries = [
  ...
  "SELECT * FROM yellow_tripdata_staging LIMIT 100 OFFSET 100",
  ...
  "SELECT pickup_longitude, pickup_latitude, r.name, p.name FROM yellow_tripdata_staging as t INNER JOIN rate_code as r ON t.rate_code_id = r.rate_code_id INNER JOIN payment_type as p ON t.payment_type = p.payment_type",
];
